...
function getOperator(tokenType) {
  switch (tokenType) {
    case tokens.TOKEN_LESS_THAN:
      return OpType.OPTR_LT;
    case tokens.TOKEN_GREATER_THAN:
      return OpType.OPTR_GT;
    case tokens.TOKEN_STAR:
      return OpType.OPTR_MUL;
    case tokens.TOKEN_STAR_STAR:
      return OpType.OPTR_POW;
    case tokens.TOKEN_MINUS:
      return OpType.OPTR_MINUS;
    case tokens.TOKEN_PLUS:
      return OpType.OPTR_PLUS;
    case tokens.TOKEN_PLUS_PLUS:
      return OpType.OPTR_PLUS_PLUS;
    case tokens.TOKEN_MINUS_MINUS:
      return OpType.OPTR_MINUS_MINUS;
    case tokens.TOKEN_F_SLASH:
      return OpType.OPTR_DIV;
    case tokens.TOKEN_MOD:
      return OpType.OPTR_MOD;
    case tokens.TOKEN_EQUAL:
      return OpType.OPTR_EQ;
    case tokens.TOKEN_QMARK:
      return OpType.OPTR_COND;
    case tokens.TOKEN_BITWISE_AND:
      return OpType.OPTR_BW_AND;
    case tokens.TOKEN_BITWISE_XOR:
      return OpType.OPTR_BW_XOR;
    case tokens.TOKEN_BITWISE_OR:
      return OpType.OPTR_BW_OR;
    case tokens.TOKEN_BITWISE_INVERT:
      return OpType.OPTR_BW_INVERT;
    case tokens.TOKEN_LESS_THAN_EQUAL:
      return OpType.OPTR_LEQ;
    case tokens.TOKEN_GREATER_THAN_EQUAL:
      return OpType.OPTR_GEQ;
    case tokens.TOKEN_EQUAL_EQUAL:
      return OpType.OPTR_EQEQ;
    case tokens.TOKEN_NOT:
      return OpType.OPTR_NOT;
    case tokens.TOKEN_NOT_EQUAL:
      return OpType.OPTR_NEQ;
    case tokens.TOKEN_BITWISE_LSHIFT:
      return OpType.OPTR_BW_LSHIFT;
    case tokens.TOKEN_BITWISE_RSHIFT:
      return OpType.OPTR_BW_RSHIFT;
    case tokens.TOKEN_MINUS_EQUAL:
      return OpType.OPTR_MINUS_ASSIGN;
    case tokens.TOKEN_PLUS_EQUAL:
      return OpType.OPTR_PLUS_ASSIGN;
    case tokens.TOKEN_DIV_EQUAL:
      return OpType.OPTR_DIV_ASSIGN;
    case tokens.TOKEN_STAR_EQUAL:
      return OpType.OPTR_MUL_ASSIGN;
    case tokens.TOKEN_MOD_EQUAL:
      return OpType.OPTR_MOD_ASSIGN;
    case tokens.TOKEN_LSHIFT_EQUAL:
      return OpType.OPTR_BW_LSHIFT_ASSIGN;
    case tokens.TOKEN_RSHIFT_EQUAL:
      return OpType.OPTR_BW_RSHIFT_ASSIGN;
    case tokens.TOKEN_AND_EQUAL:
      return OpType.OPTR_BW_AND_ASSIGN;
    case tokens.TOKEN_OR_EQUAL:
      return OpType.OPTR_BW_OR_ASSIGN;
    case tokens.TOKEN_XOR_EQUAL:
      return OpType.OPTR_BW_XOR_ASSIGN;
    case tokens.TOKEN_STAR_STAR_EQUAL:
      return OpType.OPTR_POW_ASSIGN;
    case tokens.TOKEN_OR:
      return OpType.OPTR_OR;
    case tokens.TOKEN_AND:
      return OpType.OPTR_AND;
    case tokens.TOKEN_INSTANCEOF:
      return OpType.OPTR_INSTOF;
    default:
      return undefined;
  }
}
